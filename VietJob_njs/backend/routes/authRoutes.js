...
router.post("/social-login", authController.socialLogin);           // Legacy (access token)
router.post("/google-callback",   authController.googleCallback);   // Google OAuth code flow
router.post("/linkedin-callback", authController.linkedInCallback); // LinkedIn OAuth code flow
