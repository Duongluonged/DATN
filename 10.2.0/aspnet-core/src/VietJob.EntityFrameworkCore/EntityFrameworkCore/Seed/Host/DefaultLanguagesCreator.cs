...
namespace VietJob.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly VietJobDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = VietJobConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(VietJobDbContext context)
    {
        _context = context;
    }
