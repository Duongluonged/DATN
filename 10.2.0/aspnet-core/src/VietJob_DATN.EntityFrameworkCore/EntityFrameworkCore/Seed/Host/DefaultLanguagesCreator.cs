...
namespace VietJob_DATN.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly VietJob_DATNDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = VietJob_DATNConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(VietJob_DATNDbContext context)
    {
        _context = context;
    }
