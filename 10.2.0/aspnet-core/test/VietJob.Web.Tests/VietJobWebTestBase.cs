...
using VietJob.Models.TokenAuth;
...
public abstract class VietJobWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static VietJobWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(VietJobWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<VietJobDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<VietJobDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<VietJobDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<VietJobDbContext, Task<T>> func)
    {
        T result;
