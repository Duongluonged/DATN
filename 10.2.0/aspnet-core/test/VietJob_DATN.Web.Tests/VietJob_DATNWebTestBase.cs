...
public abstract class VietJob_DATNWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static VietJob_DATNWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(VietJob_DATNWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<VietJob_DATNDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<VietJob_DATNDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<VietJob_DATNDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<VietJob_DATNDbContext, Task<T>> func)
    {
        T result;
