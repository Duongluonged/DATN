  ...
  return (
    <aside className="sticky top-0 w-64 min-w-[256px] h-screen bg-white border-r border-gray-200 flex flex-col font-sans">
      ...
      <div className="flex items-center gap-3 p-6 border-b border-gray-100">
        ...
        <div>
          <div className="font-bold text-gray-900 text-sm leading-tight">Admin Portal</div>
        ...
        {menuItems.map((item, index) => (
          item.type === "divider" ? (
            ...
            <NavLink
              ...
              to={item.to}
              className={({ isActive }) =>
                `flex items-center gap-3 px-4 py-2.5 text-[13px] transition-all rounded-lg border-l-4 ${
                  isActive
