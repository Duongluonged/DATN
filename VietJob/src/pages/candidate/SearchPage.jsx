          ...
          {loading ? (
            ...
            <div className="grid grid-cols-12 gap-5">
              ...
              <div className="col-span-7 ">
                <div className="bg-white rounded-2xl p-6 sticky top-5 border border-gray-200 text-black">
                  {selectedJob && (
                    <>
                      <div className="flex gap-5">
                        ...
                        <div className="flex-1">
                          <h1 className="text-3xl text-black font-bold leading-snug">
                      ...
                      <div className="overflow-y-auto max-h-[calc(100vh-280px)]">
                        ...
                        <div className="border-t mt-6 pt-5 space-y-3 text-sm">
                          ...
                          <div className="flex items-center gap-3">
                            <span className="font-semibold text-black w-24">Cấp bậc:</span>
                        ...
                        <div className="border-t mt-6 pt-5">
                          ...
                          <div className="text-black-700 leading-8 text-sm">
