    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      <div className="max-w-5xl w-full bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row h-[650px]">
        ...
        <div className="hidden md:flex md:w-1/2 relative flex-col justify-end">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-blue-500 via-blue-500/50 to-transparent mix-blend-multiply"></div>
          ...
          <div className="relative z-10 p-10 text-white">
            ...
            <p className="text-blue-100 text-sm max-w-sm">
              Tham gia cộng đồng VietJob để tiếp cận hàng ngàn việc làm công nghệ hấp dẫn nhất.
            </p>
          </div>
        </div>
