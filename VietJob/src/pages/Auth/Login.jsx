...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // 2. Lấy dữ liệu trả về từ Backend (token, username, roles, id)
      ...
      // 5. Điều hướng thông minh dựa trên quyền (chỉ Admin & Ứng viên)
      if (roles.includes("Employer")) {
        // Nhà tuyển dụng phải dùng trang đăng nhập riêng
        localStorage.removeItem("user");
        alert("Tài khoản nhà tuyển dụng vui lòng đăng nhập tại trang dành riêng cho nhà tuyển dụng.");
        return;
